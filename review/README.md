...
**最新进展（2026-09-14）**：用户第5～10及11.1/11.2已报告完成，11.3未完成。帮助入口与Bridge统计另列缺陷并已补修，不能以步骤完成代替统计复验。经典工作台空内置模型、菜单越界和主题问题已修复；按授权收敛为轻量界面并保留认证Bridge。代码/浏览器证据见CURRENT_AUDIT，重启复验见根目录Windows新手逐步验收。
