...
| [docs-site/source-index.md](../docs-site/source-index.md) | 生成定位，非语义认证 | e78490a230b744fe | 检查生成一致性，逐函数含义另查主说明 |
...
| [manager/CONTEXT.md](../manager/CONTEXT.md) | 局部核对 | 2def8463f1c12e73 | F54压缩为轻量当前索引，记录来源同步/50c03be精确CI与未修新证据；历史保留阶段，不自授整篇通过 |
| [manager/SKILL.md](../manager/SKILL.md) | 只读规范副本 | 5c8c93d50e52332b | 只核对引用与适用范围，不修改技能副本 |
| [manager/agents.md](../manager/agents.md) | 待逐句核对 | 99d1a782f6a6cb5b | 不继承旧批次整篇通过；逐句比对来源/失败/权限/平台 |
...
| [manager/stages/s10-upstream-adoption.md](../manager/stages/s10-upstream-adoption.md) | 局部核对 | b571b3822298d7c0 | F54更新R2/R3与实际审查/未修边界、基线和ShunCode取舍；保留历史失败，其余阶段不重签 |
...
| [review/SEMANTIC_REVIEW_2026-09-16.md](../review/SEMANTIC_REVIEW_2026-09-16.md) | 待逐句核对 | 6cd91c431bfe2d34 | F54只更新当前状态/新证据和精确基线，历史长台账仍逐段待核，不自授整篇通过 |
...
| [webagent-core/agent-host/scripts/README.md](../webagent-core/agent-host/scripts/README.md) | 待逐句核对 | bdd758417e4bf457 | 不继承旧批次整篇通过；逐句比对来源/失败/权限/平台 |
| [webagent-core/agent-host/scripts/运行器详解.md](../webagent-core/agent-host/scripts/运行器详解.md) | 待逐句核对 | 82b46c419b33377c | 不继承旧批次整篇通过；逐句比对来源/失败/权限/平台 |
...
| [webagent-core/agent-host/src/mcp/README.md](../webagent-core/agent-host/src/mcp/README.md) | 局部核对 | 3467830430b938ed | F53扩展clientInfo固定入库/status投影与HTTP证据；F50/F47外部结果及F40会话局部保留 |
...
| [webagent-core/agent-host/src/utils/受控工具与工作流详解.md](../webagent-core/agent-host/src/utils/受控工具与工作流详解.md) | 局部核对 | 9cd7e3ced097d562 | F50核对外部unknown终态、ok:false与不可重放；F48–46队列/workflow局部保留，非全链认证 |
...
| [webagent-core/agent-host/tests/README.md](../webagent-core/agent-host/tests/README.md) | 局部核对 | 2edc9904a6ca2d66 | F53扩展query/服务计数/会话与定制投影证据；F52–45边界保留 |
...
| [webagent-core/agent-host/tests/安装与运行器测试详解.md](../webagent-core/agent-host/tests/安装与运行器测试详解.md) | 待逐句核对 | 140b8eae406e3fd7 | 不继承旧批次整篇通过；逐句比对来源/失败/权限/平台 |
