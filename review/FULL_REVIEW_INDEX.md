...
现存条目数：199（合并退役2项，不计通过）；状态：待逐句核对 86、暂停，只登记路径 15、生成定位，非语义认证 1、已逐句核对 8、待边界核对 7、只读规范副本 1、待历史定位核对 32、原始证据，受限 1、局部核对 48。这是文件计数，不是语义准确率。
...
| [docs-site/source-index.md](../docs-site/source-index.md) | 生成定位，非语义认证 | 8b9cc5a9cba67376 | 检查生成一致性，逐函数含义另查主说明 |
...
| [webagent-core/agent-host/src/api/路由逐项详解.md](../webagent-core/agent-host/src/api/路由逐项详解.md) | 局部核对 | c03cdaa602ac5f18 | F46扩展审批终态保留/过期语义；F45文件createOnly段保留，其它长篇路由仍待逐句 |
...
| [webagent-core/agent-host/src/tools/README.md](../webagent-core/agent-host/src/tools/README.md) | 局部核对 | 37a449de16a2ccad | F46扩展workflow及目录/命令/日志/任务状态caller隔离；F45及前批局部保留 |
...
| [webagent-core/agent-host/src/utils/受控工具与工作流详解.md](../webagent-core/agent-host/src/utils/受控工具与工作流详解.md) | 局部核对 | 71df7d2d45d6e9e7 | F46核对operatorQueue保留/过期与workflow schema段；前批stdio等局部保留，非全链认证 |
...
| [webagent-core/agent-host/tests/README.md](../webagent-core/agent-host/tests/README.md) | 局部核对 | 0aa353e917ee7b13 | F46扩展审批/workflow/目录ACL/命令/日志/任务状态回归；F45边界保留 |
