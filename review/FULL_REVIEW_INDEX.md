...
现存条目数：197（合并退役2项，不计通过）；状态：待逐句核对 120、暂停，只登记路径 15、生成定位，非语义认证 1、已逐句核对 5、待边界核对 7、只读规范副本 1、待历史定位核对 32、原始证据，受限 1、局部核对 15。这是文件计数，不是语义准确率。
...
| [webagent-core/agent-host/src/utils/主机诊断与调用追踪详解.md](../webagent-core/agent-host/src/utils/主机诊断与调用追踪详解.md) | 局部核对 | ade61212f2c117cd | F35仅仅checkpointCreateBrowser测试段，探测专项仍暂停
...
| [webagent-core/agent-host/src/utils/受控工具与工作流详解.md](../webagent-core/agent-host/src/utils/受控工具与工作流详解.md) | 局部核对 | e5a4b42d987767ba | F35仅createCheckpoint在途/快照/确认与列表失败分离段；前批局部范围保留，其余长篇未认证
...
| [webagent-core/agent-host/tests/README.md](../webagent-core/agent-host/tests/README.md) | 局部核对 | fa8dce4882c6aded | F35仅创建检查点分列证据段；其余仍待逐句
...
| [webagent-core/agent-host/tests/浏览器与Webview测试详解.md](../webagent-core/agent-host/tests/浏览器与Webview测试详解.md) | 局部核对 | 6a9a213a4752bcff | F35仅创建检查点VM生命周期段；前批局部范围保留
...
| [webagent-core/workbench/js/README.md](../webagent-core/workbench/js/README.md) | 局部核对 | 080fbc705f4c0f4b | F35仅创建互斥与创建后刷新分离导航段；前批局部范围保留
...
| [使用指南.md](../使用指南.md) | 局部核对 | a475409379f17d1d | F35仅创建检查点的草稿/未知/非重试边界段；前批局部范围保留
