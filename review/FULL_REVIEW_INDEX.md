...
现存条目数：199（合并退役2项，不计通过）；状态：待逐句核对 83、暂停，只登记路径 15、生成定位，非语义认证 1、已逐句核对 8、待边界核对 7、只读规范副本 1、待历史定位核对 32、原始证据，受限 1、局部核对 51。这是文件计数，不是语义准确率。
...
| [docs-site/source-index.md](../docs-site/source-index.md) | 生成定位，非语义认证 | 1030cb24105f7be5 | 检查生成一致性，逐函数含义另查主说明 |
...
| [manager/CONTEXT.md](../manager/CONTEXT.md) | 局部核对 | 4491252807619ccc | F45同步当前修复、验证缺口和报告导航；其它阶段/用户实机事实不重签 |
...
| [manager/stages/s10-upstream-adoption.md](../manager/stages/s10-upstream-adoption.md) | 局部核对 | f5d1ca3e6b4ba910 | F45更新R3/R9状态并登记本批证据边界；整篇历史批次不重新认证 |
...
| [review/FULL_AUDIT_FOLLOWUP_2026-09-18.md](../review/FULL_AUDIT_FOLLOWUP_2026-09-18.md) | 待逐句核对 | a09306c49f30ec07 | F45新增交叉审查/实修与验证报告；本页不自我授予整篇语义认证，结论按列明证据边界复核 |
| [review/README.md](../review/README.md) | 局部核对 | efeb6aa96aed3a71 | F45新增交叉审查入口并区分原始报告/现行处置；其它历史入口范围保留 |
| [review/SEMANTIC_REVIEW_2026-09-16.md](../review/SEMANTIC_REVIEW_2026-09-16.md) | 待逐句核对 | ea68252929a17906 | 不继承旧批次整篇通过；逐句比对来源/失败/权限/平台 |
...
| [webagent-core/agent-host/src/agent/模型调用详解.md](../webagent-core/agent-host/src/agent/模型调用详解.md) | 局部核对 | a05400857526efdb | F47核对providerCatalog/addProvider整表预算与普通模型设置边界；openai/runChat其余段未重审 |
| [webagent-core/agent-host/src/api/README.md](../webagent-core/agent-host/src/api/README.md) | 局部核对 | 2c990e771ad3a32d | F47核对模型严格更新/掩码连接绑定摘要；F45 createOnly及前批局部范围保留 |
| [webagent-core/agent-host/src/api/路由逐项详解.md](../webagent-core/agent-host/src/api/路由逐项详解.md) | 局部核对 | 5b5841642a3df214 | F47核对POST models调用链；F46审批终态及F45 createOnly段保留，其它长篇路由仍待逐句 |
...
| [webagent-core/agent-host/src/utils/受控工具与工作流详解.md](../webagent-core/agent-host/src/utils/受控工具与工作流详解.md) | 局部核对 | 5a16cf16bd2f56ec | F47核对external结果派生与workflow部分读取段；F46队列/schema及前批stdio局部保留，非全链认证 |
...
| [webagent-core/agent-host/tests/README.md](../webagent-core/agent-host/tests/README.md) | 局部核对 | a248552f994e1d45 | F47扩展外部失败/部分读取/模型事务回归；F46审批/caller隔离及F45边界保留 |
...
| [webagent-core/agent-host/tests/补丁与编辑API测试详解.md](../webagent-core/agent-host/tests/补丁与编辑API测试详解.md) | 局部核对 | 71932f1e071ae0f5 | F47扩展模型设置真实HTTP事务负例；F45 createOnly及前批局部保留 |
