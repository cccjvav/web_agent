...
| [docs-site/source-index.md](../docs-site/source-index.md) | 生成定位，非语义认证 | 0eb0a0d0d349258f | 检查生成一致性，逐函数含义另查主说明 |
...
| [manager/CONTEXT.md](../manager/CONTEXT.md) | 局部核对 | 58c7beef9559d7bb | F54压缩为轻量当前索引，记录来源同步/50c03be精确CI与未修新证据；历史保留阶段，不自授整篇通过 |
...
| [manager/stages/s10-upstream-adoption.md](../manager/stages/s10-upstream-adoption.md) | 局部核对 | aa2da40be73b2c28 | F54更新R2/R3与实际审查/未修边界、基线和ShunCode取舍；保留历史失败，其余阶段不重签 |
...
| [review/INDEPENDENT_AUDIT_2026-09-20.md](../review/INDEPENDENT_AUDIT_2026-09-20.md) | 待逐句核对 | 9a252790ac303d40 | F54独立证据与取舍；新报告不自授通过，不等同产品修复、全仓逐句或实机认证 |
...
| [review/SEMANTIC_REVIEW_2026-09-16.md](../review/SEMANTIC_REVIEW_2026-09-16.md) | 待逐句核对 | e119317b09813744 | F54只更新当前状态/新证据和精确基线，历史长台账仍逐段待核，不自授整篇通过 |
...
| [webagent-core/agent-host/src/tools/README.md](../webagent-core/agent-host/src/tools/README.md) | 局部核对 | 910b5959bbdea049 | F50登记外部unknown/失败判定顺序与不可重放；F47/F46及前批局部保留 |
...
| [webagent-core/agent-host/tests/README.md](../webagent-core/agent-host/tests/README.md) | 局部核对 | c652a710148d5b13 | F53扩展query/服务计数/会话与定制投影证据；F52–45边界保留 |
...
| [webagent-core/agent-host/tests/工作区与命令安全测试详解.md](../webagent-core/agent-host/tests/工作区与命令安全测试详解.md) | 局部核对 | 003574084674f24d | F43仅nativeRotationCommands夹具与断言段；其余仍待逐句 |
...
| [webagent-core/extension/README.md](../webagent-core/extension/README.md) | 局部核对 | 57ed2e8597736b92 | F45扩展PTY严格回包边界；其余扩展功能仍待逐句 |
...
| [webagent-core/extension/入口与Webview详解.md](../webagent-core/extension/入口与Webview详解.md) | 局部核对 | 12269410725f1c47 | F43仅activate命令委托、workspaceSnapshot/validRotationResult/resetSecretCommand与停止消费段；其余仍待逐句 |
...
| [webagent-core/extensions-installed/webagent.webagent-core-0.7.2/入口与Webview详解.md](../webagent-core/extensions-installed/webagent.webagent-core-0.7.2/入口与Webview详解.md) | 待边界核对 | 12269410725f1c47 | 冻结原型/示例/发行副本，不冒称产品主线语义认证 |
