...
| [docs-site/source-index.md](../docs-site/source-index.md) | 生成定位，非语义认证 | 58e4ecade920c7e2 | 检查生成一致性，逐函数含义另查主说明 |
...
| [installer/函数详解.md](../installer/函数详解.md) | 待逐句核对 | d8567724786d670c | 不继承旧批次整篇通过；逐句比对来源/失败/权限/平台 |
| [installer/安装声明详解.md](../installer/安装声明详解.md) | 待逐句核对 | 5c8566d2ce5b1bc8 | 不继承旧批次整篇通过；逐句比对来源/失败/权限/平台 |
| [manager/CONTEXT.md](../manager/CONTEXT.md) | 局部核对 | 4a51232fdbd7c680 | F54压缩为轻量当前索引，记录来源同步/50c03be精确CI与未修新证据；历史保留阶段，不自授整篇通过 |
| [manager/SKILL.md](../manager/SKILL.md) | 只读规范副本 | 5c8c93d50e52332b | 只核对引用与适用范围，不修改技能副本 |
| [manager/agents.md](../manager/agents.md) | 待逐句核对 | 519e7f0c793649c9 | 不继承旧批次整篇通过；逐句比对来源/失败/权限/平台 |
...
| [manager/stages/s10-upstream-adoption.md](../manager/stages/s10-upstream-adoption.md) | 局部核对 | f9be1d87ab37aa79 | F54更新R2/R3与实际审查/未修边界、基线和ShunCode取舍；保留历史失败，其余阶段不重签 |
...
| [review/SEMANTIC_REVIEW_2026-09-16.md](../review/SEMANTIC_REVIEW_2026-09-16.md) | 待逐句核对 | 07a21c2b5da958be | F54只更新当前状态/新证据和精确基线，历史长台账仍逐段待核，不自授整篇通过 |
...
| [webagent-core/agent-host/scripts/运行器详解.md](../webagent-core/agent-host/scripts/运行器详解.md) | 待逐句核对 | dcfc95b92bca11da | 不继承旧批次整篇通过；逐句比对来源/失败/权限/平台 |
...
| [webagent-core/agent-host/src/tunnel/README.md](../webagent-core/agent-host/src/tunnel/README.md) | 待逐句核对 | 00fe68e36c008b17 | 不继承旧批次整篇通过；逐句比对来源/失败/权限/平台 |
| [webagent-core/agent-host/src/tunnel/停止进程详解.md](../webagent-core/agent-host/src/tunnel/停止进程详解.md) | 待逐句核对 | 4a9841293ce55bfa | 不继承旧批次整篇通过；逐句比对来源/失败/权限/平台 |
...
| [webagent-core/agent-host/tests/README.md](../webagent-core/agent-host/tests/README.md) | 局部核对 | b2bd48fe629d5101 | F53扩展query/服务计数/会话与定制投影证据；F52–45边界保留 |
