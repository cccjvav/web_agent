...
M项不是用户既有手机F2结果、11.3关闭记录或CI通过的重复认证；现在全部未代用户执行。本轮（第七批、F71、F72）按[R8本轮Arena实机验收](../docs/guides/R8本轮Arena实机验收.md)执行：M1＝7.1，M2＝7.2，M3＝第2步（含可选浏览器回归），M4＝7.2b，M5＝9.2与第10步。2026-09-24用户执行结果见[R8实机验收记录](R8实机验收记录-2026-09-24.md)：M1–M4通过，M5的9.2（PTY确认框）未执行，第10步收尾完成。
