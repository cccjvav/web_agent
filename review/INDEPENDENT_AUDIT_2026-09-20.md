...
> 阅读顺序：第1–6节保留2026-09-20的F54历史观察；2026-09-21的浏览器/界面修复见第7节F55，后续启动可靠性见第8节F56，身份与准备取消见第9–11节。当前工作包只在阶段10维护。
...
| F59-02 | 打开浏览器后没有再次核对实例，可能把已变身份当成干净移交 | 浏览器打开后再`inspectPair`；不匹配使用既有“窗口可能已打开，未移交后台”，不终止另一服务 |
