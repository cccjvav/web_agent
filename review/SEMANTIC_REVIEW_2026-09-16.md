...
第57组F57：拆分外层appWindow.js并修复就绪误判、错工作区复用、浏览器失败及后台清理未确认；新增28个分层场景，本地96/96、Chromium与audit 0均退出0。文档276/28/111且updated=0，185指纹同步。精确提交/CI见阶段10第57组。正式201项：已逐句8、局部69、待66，其他不变；只扩大9份受影响说明的局部核对。R2/R3外层再确认、R4旧原因、R5/R8实际桌面及全仓逐句、探针暂停均保留。
