...
const TOOLS = [
  ...
  },
  {
    ...
    description: 'Report current task status, step name, and completion percentage to the ShunCode IDE host UI.',
    inputSchema: {
      type: 'object',
      properties: {
        message: {
  ...
  {
    name: 'set_todos',
    description: 'Update the task breakdown and TODO list displayed in the ShunCode host IDE UI.',
    inputSchema: {
      type: 'object',
      properties: {
        todos: {
