...
assert(docs.fileIndex.some(item => item.path === 'manager/stages/s10-upstream-adoption.md'), 'existing stage plan is indexed');
assert(docs.fileIndex.some(item => item.path === 'manager/CONTEXT.md'), 'original management index is available in actual generated viewer content');
