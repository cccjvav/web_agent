...
for (const name of ['README.md', '架构导读.md', '组件说明.md', '总览.md', '技术实现.md', '测试说明.md', '代码复盘指南.md', 'review/SEMANTIC_REVIEW_2026-09-16.md', 'Conda环境说明.md', '平台启动与CI详解.md', '隧道使用指南.md', '技能使用指南.md', 'Windows新手逐步验收.md', 'review/CHECKLIST_WINDOWS.md']) checkLinks(name, read(name));
