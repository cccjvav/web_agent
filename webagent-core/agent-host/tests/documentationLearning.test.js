...
const pairs = [
  ["webagent-core/agent-host/tests/tunnelRecoveryLauncher.test.js", "installer/函数详解.md"],
  ...
  ["webagent-core/agent-host/tests/tunnelCleanupWindows.test.js", "webagent-core/agent-host/src/tunnel/停止进程详解.md"],
  ["webagent-core/agent-host/scripts/tunnel-cleanup.js", "webagent-core/agent-host/scripts/运行器详解.md"],
  ["webagent-core/agent-host/src/tunnel/receiptProtection.js", "webagent-core/agent-host/src/tunnel/停止进程详解.md"],
  ["webagent-core/agent-host/tests/tunnelReceiptProtection.test.js", "webagent-core/agent-host/src/tunnel/停止进程详解.md"],
  ...
  ['webagent-core/agent-host/tests/publicHttps.test.js', 'webagent-core/agent-host/src/mcp/公网出站详解.md'],
  ['webagent-core/agent-host/src/utils/editorUndo.js', 'webagent-core/agent-host/src/utils/编辑回退详解.md'],
  ...
  ["webagent-core/agent-host/tests/probeLegacyImport.test.js", "webagent-core/probe-extension/实现详解.md"],
  ...
  ["webagent-core/agent-host/tests/probeTransport.test.js", "webagent-core/agent-host/tests/浏览器与Webview测试详解.md"],
  ["webagent-core/agent-host/src/utils/connectionCheck.js", "webagent-core/agent-host/src/utils/受控工具与工作流详解.md"],
  ["webagent-core/agent-host/tests/connectionCheck.test.js", "webagent-core/agent-host/src/utils/受控工具与工作流详解.md"],
  ...
  ["webagent-core/agent-host/tests/skillsLifecycle.test.js", "webagent-core/agent-host/src/tools/技能与隐藏规则详解.md"],
  ...
  ['webagent-core/agent-host/tests/hostDiagnostics.test.js', 'webagent-core/agent-host/src/utils/主机诊断与调用追踪详解.md'],
  ...
  ["webagent-core/agent-host/tests/hostLaunch.test.js", "webagent-core/agent-host/tests/安装与运行器测试详解.md"],
  ["webagent-core/extension/hostManager.js", "webagent-core/extension/入口与Webview详解.md"],
  ["webagent-core/agent-host/src/utils/lifeline.js", "webagent-core/agent-host/src/入口详解.md"],
...
const artifactPairs = [
  ["installer/tunnel-recovery.ps1", "installer/函数详解.md"],
  ["webagent-core/agent-host/tests/tunnelCleanupAclFixture.cs", "webagent-core/agent-host/src/tunnel/停止进程详解.md"],
  ["webagent-core/agent-host/tests/tunnelCleanupAclFixture.ps1", "webagent-core/agent-host/src/tunnel/停止进程详解.md"],
  ["webagent-core/agent-host/src/tunnel/tunnelCleanup.cs", "webagent-core/agent-host/src/tunnel/停止进程详解.md"],
  ["webagent-core/agent-host/src/tunnel/tunnelCleanup.ps1", "webagent-core/agent-host/src/tunnel/停止进程详解.md"],
  ["webagent-core/agent-host/src/tunnel/receiptProtection.ps1", "webagent-core/agent-host/src/tunnel/停止进程详解.md"],
