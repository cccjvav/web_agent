...
| [appWindowLifecycle.test.js](appWindowLifecycle.test.js) | 89 个函数/类节点 |
...
| [installerPreparation.test.js](installerPreparation.test.js) | 49 个函数/类节点 |
...
| [workspaceEntry.test.js](workspaceEntry.test.js) | 21 个函数/类节点 |
