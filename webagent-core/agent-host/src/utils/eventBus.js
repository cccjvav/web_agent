...
const SECRET_KEYS = /^(apiKey|token|password|secret|secretKey|authorization|access_token|refresh_token|pat|oldSecret|newSecret|namedToken|ngrokToken|authtoken)$/i;
const MAX_WS = 32;
