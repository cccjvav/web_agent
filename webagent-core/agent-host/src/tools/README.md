...
完整工具实现详解：[补丁与路径详解](补丁与路径详解.md) · [文件与搜索详解](文件与搜索详解.md) · [命令与PTY详解](命令与PTY详解.md) · [工具入口与命令策略详解](工具入口与命令策略详解.md) · [任务板与工作区详解](任务板与工作区详解.md)。与原Plan、缓存、Skill详解合起来覆盖本目录18个源码文件。
...
| [executor.js](executor.js) | 29 个函数/类节点 |
