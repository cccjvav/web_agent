...
逐函数正文：[状态与编辑器详解](js/状态与编辑器详解.md) · [启动与Chat详解](js/启动与Chat详解.md) · [Bridge与设置详解](js/Bridge与设置详解.md) · [交互绑定详解](js/交互绑定详解.md)。包含启动、事件绑定、编辑器保存、Chat流、Bridge与设置；HTML/CSS精细说明仍单独跟进。
