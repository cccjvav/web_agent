...
| 接手与继续全部待办 | [管理路线R0–R8/P](../manager/ROADMAP.md)、[管理索引](../manager/CONTEXT.md) |
...
交接与项目管理是一套体系：根交接页只导航，manager/ROADMAP维护工作包，CONTEXT维护接手摘要，stages维护实施证据；审查清单单独记录文件覆盖而非第二份项目计划。
