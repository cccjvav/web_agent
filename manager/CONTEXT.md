...
## 当前阶段
- **阶段10：继续上游借鉴与文档整顿**。Tasks隔离/刷新恢复与初步编辑预览（核心0.7.2）已交付；所有者权限与Chat/Bridge互斥已交付，当前推进经典单文件受保护回退，并继续文档逐句审查与旧指南退役、过期内容清理与实际缺口复核；见[阶段10](stages/s10-upstream-adoption.md)。阶段9工作区调整已交付。
...
- 当前产品代码6e57fec3668eaefdc56d7efd0b8721ee01b7d6d4（经典编辑预览/确认保存与安全提示），CI35101343496九项成功，含真实Chromium、Windows安装器和七组Node矩阵。本地78测试文件通过，237源码/28目录/109排除。核心0.7.2、Companion0.5.2未改；新控件真实Windows/手机人工验收仍待。
