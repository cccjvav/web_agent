...
- 当前续作：第39组OAuth凭据/issuer生产入口回归通过，未复现认证绕过、未改产品认证源码；补撤销归属/真实MCP失效、表单授权及发现/挑战一致性。OAuth说明新增整篇核对1，本地82测试/文档检查通过，本批CI待核验。下一包R2 MCP会话/peer与凭据、任务/取消边界；R3余项/全仓/实机保留，探测暂停。
