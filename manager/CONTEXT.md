...
- **R5用户已授权安全残留回收，首包先做归属与只读检测。** 三个隧道启动点记私有无Token收据，CLI有限检测并保护活实例；只读报告所有canCleanup=false，图形按钮/API仍未提供。旧版无记录/不确定身份不认领；下一包须稳定句柄与本机确认，不复用停止Bridge。本地88/88，修订9b8ed65的CI35590001850九项通过；首轮Windows夹具失败及修订证据见阶段10。
