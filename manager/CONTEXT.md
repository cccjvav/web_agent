...
## 当前状态
- **第六批窄屏/页签ARIA修复已实施，本地85/85及真实Chromium/两条axe规则通过，精确CI待核验。** 从干净4d6c580接续，先真实浏览器红测主区零宽；改为窄屏显式单工作面、tablist外关闭当前页，保留草稿/dirty确认/焦点和桌面双栏。探针暂停不变，实际Windows/读屏器仍未验。
