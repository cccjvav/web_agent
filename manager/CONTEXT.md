...
- 当前续作：第37组stdio不完整预览/空启动响应已先红测再修，完整快照/绑定/过期复查、在途互斥与未知不重启；真实后端快照/单次消费回归加强，后端未改。本地82测试/文档检查与精确CI九项通过，含新增Chromium stdio场景。下一包R2本机控制面/跨站拒绝链，R3其它消费者仍保留；全仓/实机未完成，探测暂停。
