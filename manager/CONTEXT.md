...
- **正在做**：第一批已完成；第二批编辑器F09/F10已提交4e016fc；第三批F07已提交69a7f07；第四批安装CI编译已通过；第五批模型失败/Plan/认证/session/board/配置一致性修复。第六批PTY/取消代码修复，剩余隧道竞态、输出预算/正则及Windows桌面操作，见活台账。用户已确认五项方向，见活台账第五节；包括手机Arena经MCP发布任务（不开放远程UI）。
