...
- **R7本轮完成：Markdown文档时效核对。** 以f317c44为基线枚举200份.md，逐份记录现行一致/修正、第三方待证据、历史/只读/生成/暂停；未留“待核对”。文档修正不等于外部兼容、实机或全仓源码安全认证，结果见[文档清单](../review/FULL_REVIEW_INDEX.md)。
...
- **阶段10进行中，核心0.7.2，不是只剩实机。** R2/R3其余消费链/权限合同、R8本机验收仍开放；R6/R9候选按收益和授权取舍。全部优先级和完成条件只维护在[工作包表](stages/s10-upstream-adoption.md#当前工作包与交接约束)。持久登录/确切后端身份任务仍延期。
